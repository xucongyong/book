...
export default async function ({
  ...
  const form: FormSlotType = {
    ...
    fields: [
      ...
      {
        name: "is_paid",
        title: "Is Paid (Pro Only)",
        type: "select",
        options: [
          { title: "No (Free)", value: "false" },
          { title: "Yes (Paid)", value: "true" },
        ],
        value: post.is_paid ? "true" : "false",
        tip: "If enabled, only Pro members can view the full content",
      },
    ],
    data: post,
    passby: {
